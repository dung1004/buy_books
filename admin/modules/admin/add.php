       ...
       if ($_SERVER["REQUEST_METHOD"] == "POST") 
       {
            ...
            if (postInput('name') == '') {
             ...
             if (postInput('password') == '') {
                $err['password'] = "Mời bạn nhập password";
            }
             if ($data['password'] != postInput('configPassword')) 
             {
               $err['password'] = "Mật khẩu không khớp. Vui lòng nhập lại";
             }
                    ...
                    <div class="themmoisanpham">
                        <form action="" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <div class="col-md-10">
                               <input type="text" name="name" class="form-control" id="name" value="<?= $data['name'] ?>"   placeholder="Enter name product">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-md-10">
                               <input type="text" name="username" class="form-control" id="name" value="<?= $data['username'] ?>"  placeholder="username" >
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-md-10">
                               <input type="password" name="password" class="form-control" id="name"  placeholder="**********" value="<?= $data['password'] ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-10">
                               <input type="password" name="configPassword" class="form-control" id="name"  placeholder="**********" required>
